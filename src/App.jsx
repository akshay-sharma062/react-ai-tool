  ...
  return (
   ...
   <RecentSearch recentHistory={recentHistory} setRecentHistory={setRecentHistory} setSelectedHistory={setSelectedHistory} />
      <div className='col-span-4 p-10'>
        <h1 className='text-4xl bg-clip-text mb-6 text-transparent bg-gradient-to-r from-pink-700 to-violet-700'
        ...
        <div className='dark:bg-zinc-800 bg-red-100 w-1/2 p-1 pr-5 dark:text-white text-zinc-800 mt-4  m-auto rounded-4xl
